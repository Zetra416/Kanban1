...
var _default = {
  ...
  methods: {
    ...
    editTask: function editTask(id) {
      ...
      this.$emit('emitEdit', newData);
    }
  }
};
exports.default = _default;
        var $b1f5fe = exports.default || module.exports;
      
      if (typeof $b1f5fe === 'function') {
        $b1f5fe = $b1f5fe.options;
      }
    
        /* template */
        Object.assign($b1f5fe, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", { staticClass: "card" }, [
    _c("footer", { staticClass: "card-footer" }, [
      _c("h3", [_vm._v("Title : " + _vm._s(_vm.task.title))]),
      _vm._v(" "),
      _c("h4", [_vm._v("Created By : " + _vm._s(_vm.task.User.email))]),
      _vm._v(" "),
      _c("h4", [_vm._v("Created At : " + _vm._s(_vm.task.createdAt))]),
      _vm._v(" "),
      _c(
        "a",
        {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b1f5fe', $b1f5fe);
          } else {
            api.reload('$b1f5fe', $b1f5fe);
          }
        }
...
},{"_css_loader":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/CategoryCard.vue":[function(require,module,exports) {
"use strict";
...
//
var _default = {
  props: ['id', 'categoryName', 'dataTask', 'status'],
  methods: {
    deleteTask: function deleteTask(newData) {
      this.$emit('deleteTask', newData);
    },
    editTask: function editTask(newData) {
      this.$emit('editTask', newData);
    }
  },
  components: {
    Task: _TaskCard.default
  }
};
exports.default = _default;
        var $28aa5c = exports.default || module.exports;
      
      if (typeof $28aa5c === 'function') {
        $28aa5c = $28aa5c.options;
      }
    
        /* template */
        Object.assign($28aa5c, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
      ...
      _c(
        ...
        [
          ...
          _c("span", { staticClass: "tag is-dark" }, [
            _vm._v(_vm._s(_vm.dataTask.length))
          ]),
          _vm._v(" "),
          _vm._l(_vm.dataTask, function(item) {
            return _vm.dataTask.length > 0
              ? _c(
                  "div",
                  { key: item.id, staticClass: "task-wrapper" },
                  [
                    _c("Task", {
                      attrs: { task: item },
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$28aa5c', $28aa5c);
          } else {
            api.reload('$28aa5c', $28aa5c);
          }
        }
...
},{"./TaskCard":"src/components/TaskCard.vue","_css_loader":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
var _default = {
  data: function data() {
    return {
      ...
      //pake this untuk memanggil semua data disini
      emailLogin: '',
      passwordLogin: '',
      emailRegister: '',
      passwordRegister: '',
  ...
  methods: {
    ...
    login: function login() {
      ...
      (0, _axios.default)({
        ...
        _this2.access_token = localStorage.access_token;

        _this2.getTask(); //ini contoh memanggil method
    ...
    getTask: function getTask() {
      ...
      (0, _axios.default)({
        ...
        } //ini contohnya pake this

      }).then(function (response) {
        _this3.tasksBacklog = [];
        _this3.tasksProduct = [];
        _this3.tasksDevelopment = [];
        _this3.tasksDone = [];

        _this3.filterTask(response.data);
    ...
    filterTask: function filterTask(dataTask) {
    ...
    addTask: function addTask() {
      ...
      (0, _axios.default)({
        ...
        _this4.getTask(); // console.log(this.newTaskName, this.newTaskCategory);
...
exports.default = _default;
        var $f452f2 = exports.default || module.exports;
      
      if (typeof $f452f2 === 'function') {
        $f452f2 = $f452f2.options;
      }
    
        /* template */
        Object.assign($f452f2, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _vm.access_token
      ? _c("div", { staticClass: "wrapper-main-page" }, [
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.newTaskCategory,
                        expression: "newTaskCategory"
                      }
                    ],
                    on: {
                      change: function($event) {
                        ...
                        _vm.newTaskCategory = $event.target.multiple
                          ? $$selectedVal
                          : $$selectedVal[0]
                      }
                    }
            ...
            _c(
              ...
              [
                _c("CategoryCard", {
                  attrs: {
                    status: "status-1",
                    categoryName: _vm.listCategory[0],
                    dataTask: _vm.tasksBacklog
                  },
                  on: {
                    emitUpdate: function($event) {
                      return _vm.editTask(_vm.data)
                    }
                  }
                }),
                _vm._v(" "),
                _c("CategoryCard", {
                  attrs: {
                    status: "status-2",
                    categoryName: _vm.listCategory[1],
                    dataTask: _vm.tasksProduct
                  },
                  on: {
                    emitUpdate: function($event) {
                      return _vm.editTask(_vm.data)
                ...
                _c("CategoryCard", {
                  attrs: {
                    status: "status-3",
                    categoryName: _vm.listCategory[2],
                    dataTask: _vm.tasksDevelopment
                  },
                  on: {
                    emitUpdate: function($event) {
                      return _vm.editTask(_vm.data)
                ...
                _c("CategoryCard", {
                  attrs: {
                    status: "status-4",
                    categoryName: _vm.listCategory[3],
                    dataTask: _vm.tasksDone
                  },
                  on: {
                    emitUpdate: function($event) {
                      return _vm.editTask(_vm.data)
    ...
    _vm._v(" "),
    _vm.toggleDelete
      ? _c("div", { staticClass: "elements", attrs: { id: "deletePopUp" } }, [
          _c("div", { staticClass: "box" }, [
            _c("h2", [_vm._v("Are you sure about that?")]),
            _vm._v(" "),
            _c("button", { on: { click: _vm.deleteTask } }, [
              _vm._v("Yes\n          ")
            ]),
            _c("button", { on: { click: _vm.closeDelete } }, [
              _vm._v("Cancel\n        ")
            ])
          ])
        ])
    ...
    _vm._v(" "),
    _vm.toggleEdit
      ? _c("div", { staticClass: "elements", attrs: { id: "editPopUp" } }, [
          _c("div", { staticClass: "box" }, [
            _c(
              "form",
              {
              ...
              [
                ...
                _c("br"),
                _vm._v(" "),
                _c("label", { attrs: { for: "edit-category" } }, [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f452f2', $f452f2);
          } else {
            api.reload('$f452f2', $f452f2);
          }
        }
...
},{"./components/CategoryCard":"src/components/CategoryCard.vue","axios":"node_modules/axios/index.js","_css_loader":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"node_modules/vue-google-oauth2/index.js":[function(require,module,exports) {
"use strict";
